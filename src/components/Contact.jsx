          ...
          <div className='container mx-auto px-6'>
            <div className='flex flex-col lg:flex-row gap-y-16'>
              <div className='flex-1'>
                ...
                <div className='flex flex-col lg:flex-row gap-y-16 xl:gap-y-0 mt-14'>
                  {info.map((i, idx)=> {
                        ...
                        <div>
                          <div className='flex flex-col gap-y-4'>
                            ...
                            <div className='flex items-center gap-[10px] mb-5'>
                              <FaEnvelope />
                              <div className='font-medium'>{email.address1}</div>
                            </div>  
                          </div>  
                          <a className='font-medium border-b border-secondary py-[5px]' href="#">{link}</a>
                        </div>
                      </div>
                    )
                  })}
